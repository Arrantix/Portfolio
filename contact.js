...
const words = isGerman ? {
  ...
  failed: 'Das Senden hat nicht geklappt. Deine Eingaben bleiben erhalten. Versuch es erneut oder schreib mir direkt per E-Mail.',
  unavailable: 'Das Formular ist gerade nicht erreichbar. Schreib mir bitte direkt per E-Mail.',
  captcha: 'Bitte prüfe die Summe der beiden Zahlen.',
  whitespace: 'Bitte gib hier einen Text ein.',
  copied: 'Adresse kopiert.',
  copyFailed: 'Kopieren nicht möglich. Du kannst die Adresse oben markieren.',
} : {
  pending: 'Sending your message …',
  success: 'Thank you! Your message has been sent.',
  failed: 'Your message could not be sent. Your entries have been kept. Try again or email me directly.',
  unavailable: 'The form is currently unavailable. Please email me directly.',
...
if (form) {
  ...
  const serviceReady = typeof window.emailjs?.init === 'function' && typeof window.emailjs?.send === 'function';
  if (serviceReady) {
